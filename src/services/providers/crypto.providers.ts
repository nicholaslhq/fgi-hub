...
export const coinMarketCapPlaceholder = async (): Promise<ProviderScore> => {
  ...
  if (Math.random() < 0.1) throw new Error('CoinMarketCap placeholder unavailable');
...
export const cryptoProviders = [alternativeMe, coinMarketCapPlaceholder, cryptoProviderB, socialSentiment];
